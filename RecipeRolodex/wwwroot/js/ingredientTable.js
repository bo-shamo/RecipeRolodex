...
$('.table').on('click', '.plus', function addRow(evt) {
    ...
    var newRow = `
        <tr>
            ...
            <td><input type="text" class="form-control" data-val="true" data-val-required="The IngredientsName field is required." id="NewIngredientsName" name="NewIngredientsName" /></td>
        </tr>`;
